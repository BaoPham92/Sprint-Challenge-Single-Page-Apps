...
> Answer: Seemless user experience without typical re-render of the DOM triggers by certain default actions. IE: Using a tag. This not only give a better user experience, but also assist with a performant web app.
